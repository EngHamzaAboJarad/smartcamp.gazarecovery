...
const String _avatarMale = '$_fdsDir/a2ecabc9c31a4f034b15a80dc65da332f15073e1.png';
const String _avatarFemale = '$_fdsDir/800459d11d2b9666816b4cf7f89ec01f627f5d4b.png';
const String _avatarBoy = '$_fdsDir/723067b2d46d1be887f4091a67e3bcf878514280.png';
const String _avatarGirl = '$_fdsDir/8758d41530503eeaa8cc286d599c22e734900104.png';
const String _avatarElder = '$_fdsDir/c9d63a92dd8f4bae4bd9d68da970747fd4e244e0.png';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const _MemberTile(name: 'أحمد محمد', role: 'رب الأسرة', age: 45, isHead: true),
              const _MemberTile(name: 'فاطمة علي', role: 'زوجة', age: 40),
              const _MemberTile(name: 'عمر أحمد', role: 'ابن', age: 12, isChild: true),
              const _MemberTile(name: 'سارة أحمد', role: 'ابنة', age: 9, isChild: true),
              const _MemberTile(name: 'محمد عبد الله', role: 'جد • حالة صحية', age: 75, hasHealthBadge: true),
              SizedBox(height: SizeConfig.sh(context, 20)),
              SizedBox(
...
class _MemberAvatar extends StatelessWidget {
  ...
  final String name;
  final String role;
  const _MemberAvatar({required this.isHead, required this.isChild, required this.name, required this.role});
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    _Badge(text: 'B-124 :رقم الخيمة', color: const Color(0xFF1E2732), icon: Icons.shield),
                  ],
                ),
              ],
            ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            text,
            style: TextStyle(color: Colors.white70, fontSize: SizeConfig.sp(context, 12)),
          ),
        ],
      ),
    );
...
class _IdentityRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Expanded(child: _InfoTile(card: card, title: 'هوية', value: '406301020')),
        SizedBox(width: SizeConfig.sw(context, 12)),
        Expanded(child: _InfoTile(card: card, title: 'الجوال رقم', value: '0599123456')),
      ],
    );
  }
}
...
class _InfoTile extends StatelessWidget {
  ...
  final String title;
  final String value;
  const _InfoTile({required this.card, required this.title, required this.value});
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: SizeConfig.sw(context, 6)),
              Text(title, style: TextStyle(color: Colors.white60, fontSize: SizeConfig.sp(context, 12))),
            ],
          ),
          SizedBox(height: SizeConfig.sh(context, 8)),
          Text(value, style: TextStyle(color: Colors.white, fontSize: SizeConfig.sp(context, 14), fontWeight: FontWeight.w700)),
        ],
      ),
    );
  }
...
class _StatsGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      const _StatItem(title: 'إجمالي أفراد العائلة', value: '5', icon: Icons.groups),
      ...
      const _StatItem(title: 'عدد ذوي الهمم', value: '1', icon: Icons.accessible),
    ];
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(color: Colors.white60, fontSize: SizeConfig.sp(context, 12)),
                        ),
                      ),
                    ],
                  ),
...
class _MemberTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          _MemberAvatar(isHead: isHead, isChild: isChild, name: name, role: role),
          SizedBox(width: SizeConfig.sw(context, 12)),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
                ...
                Wrap(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        role,
                        style: TextStyle(color: Colors.white60, fontSize: SizeConfig.sp(context, 11)),
                      ),
                    ),
                    Text(
                      'سنة $age',
