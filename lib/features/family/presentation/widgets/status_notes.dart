...
class StatusNotes extends StatelessWidget {
  ...
  final String? Function(String?)? notesValidator;
  final Key? notesFieldKey;

  const StatusNotes({Key? key, required this.cubit, required this.onChanged, this.notesValidator, this.notesFieldKey}) : super(key: key);
